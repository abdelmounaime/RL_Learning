...
def SARSA(env, lr=0.01, num_episodes=10000, eps=0.3, gamma= 0.95, eps_decay=0.0005):
...
if __name__ == '__main__':
    ...
    env.reset()
    Q, test_reward = SARSA(env, lr=.1, num_episodes=5000, eps=0.4, gamma=0.95, eps_decay=0.001)
